    ...
    groups+: [
      {
        ...
        rules: [
          ...
          },
          {
            ...
            expr: 'apiserver_request_total:monthly_availability - apiserver_request_total:slo_target',
          },
          {
            record: 'apiserver_request_total:monthly_availability',
            expr: '1 - apiserver_request_total:30d_failure_ratio',
          },
        ],
      },
    ],
